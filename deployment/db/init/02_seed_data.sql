...
INSERT INTO movies (title, duration, rating, description) VALUES
  ('Интерстеллар', 169, 'PG-13', 'Научно-фантастический фильм о путешествии человечества в далёкий космос'),
  ('Темный рыцарь', 152, 'PG-13', 'Криминальная драма о борьбе с преступностью в Готэме'),
  ('Начало', 148, '12+', 'Научно-фантастический триллер о кражах из подсознания'),
  ('Матрица', 136, '16+', 'Классический научно-фантастический фильм про виртуальный мир'),
  ('Аватар', 162, '12+', 'Эпический научно-фантастический фильм на планете Пандора')
ON CONFLICT DO NOTHING;
