...
func (r *repo) PurchaseBooking(ctx context.Context, userID int, bookingID string) (*orderService.Booking, []orderService.Ticket, error) {
	...
	var booking orderService.Booking
	...
	var reservations []orderService.Reservation
	...
	// Создаём билеты
	tickets := make([]orderService.Ticket, 0, len(reservations))
	...
	for _, reservation := range reservations {
		var ticket orderService.Ticket
